...
(function (factory) {
  ...
  * ============================== */
  ...
  var Tokenfield = function (element, options) {
    ...
    // bug fix by jyj: getMatchedCSSRules is not supported by firefox, and doesn't seem to work on chrome
    // see this thread for complete css copiment: 
    // http://stackoverflow.com/questions/4493449/copy-all-styles-from-one-element-to-another
    elCSSWidth = element.offsetWidth;
